...
3. URL eingeben:
   ```
   https://github.com/DEIN_USERNAME/ThermostatTile
   ```
...
> `http://IPSYMCON-IP:3777/hook/thermostat_<InstanceID>`
...
- **GET** `/hook/thermostat_<ID>` → liefert aktuellen Zustand als JSON
